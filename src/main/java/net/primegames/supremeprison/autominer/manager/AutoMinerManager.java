package net.primegames.supremeprison.autominer.manager;
...
import net.primegames.supremeprison.autominer.model.AutoMinerRegion;
...
public class AutoMinerManager {
    ...
    public AutoMinerManager(SupremePrisonAutoMiner plugin) {
        this.plugin = plugin;
