package net.primegames.supremeprison.multipliers.api;
...
public final class SupremePrisonMultipliersAPIImpl implements SupremePrisonMultipliersAPI {

    private final SupremePrisonMultipliers plugin;

    public SupremePrisonMultipliersAPIImpl(SupremePrisonMultipliers plugin) {
