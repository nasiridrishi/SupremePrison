package net.primegames.supremeprison.multipliers;
...
import net.primegames.supremeprison.multipliers.api.SupremePrisonMultipliersAPI;
import net.primegames.supremeprison.multipliers.api.SupremePrisonMultipliersAPIImpl;
...
import net.primegames.supremeprison.multipliers.repo.impl.MultipliersRepositoryImpl;
import net.primegames.supremeprison.multipliers.service.MultipliersService;
import net.primegames.supremeprison.multipliers.service.impl.MultipliersServiceImpl;
...
@Getter
public final class SupremePrisonMultipliers implements SupremePrisonModule {

    public static final String MODULE_NAME = "Multipliers";

    @Getter
    private static SupremePrisonMultipliers instance;
    private final SupremePrison core;
    @Getter
    private FileManager.Config config;
    @Getter
    private SupremePrisonMultipliersAPI api;
    ...
    public SupremePrisonMultipliers(SupremePrison plugin) {
        instance = this;
        this.core = plugin;
    }
    ...
    private void loadRankMultipliers() {
        ...
        String permPrefix = useLuckPerms ? "group." : "supremeprison.multiplier.";
    ...
    public void enable() {
        ...
        this.api = new SupremePrisonMultipliersAPIImpl(this);
    ...
    private void registerCommands() {
        Commands.create()
                .assertPermission("supremeprison.multipliers.admin")
                .handler(c -> {
                    if (c.args().size() == 4) {
