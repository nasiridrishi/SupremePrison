...
public final class EnchantGUI extends Gui {
    ...
    public EnchantGUI(SupremePrisonEnchants plugin, Player player, ItemStack pickAxe, int pickaxePlayerInventorySlot) {
    ...
    public static void init() {
        ...
        GUI_ITEM_LORE = SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getStringList("enchant_menu.item.lore");
        GUI_TITLE = TextUtils.applyColor(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.title"));
        EMPTY_SLOT_ITEM = ItemStackBuilder.
                of(CompMaterial.fromString(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.empty_slots")).toItem()).name("&e").buildItem().build();
        GUI_LINES = SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getInt("enchant_menu.lines");

        HELP_ITEM_ENABLED = SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getBoolean("enchant_menu.help_item.enabled", true);
        PICKAXE_ITEM_ENABLED = SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getBoolean("enchant_menu.pickaxe_enabled", true);
        DISENCHANT_ITEM_ENABLED = SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getBoolean("enchant_menu.disenchant_item.enabled", true);

        if (DISENCHANT_ITEM_ENABLED) {
            String base64 = SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.disenchant_item.Base64", null);

            if (base64 != null) {
                DISENCHANT_ITEM = ItemStackBuilder.of(Material.ANVIL)
                        .name(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.disenchant_item.name")).lore(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getStringList("enchant_menu.disenchant_item.lore")).build();
            } else {
                DISENCHANT_ITEM = ItemStackBuilder.of(CompMaterial.fromString(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.disenchant_item.material")).toMaterial())
                        .name(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.disenchant_item.name")).lore(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getStringList("enchant_menu.disenchant_item.lore")).build();
            }
            DISENCHANT_ITEM_SLOT = SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getInt("enchant_menu.disenchant_item.slot");

        }

        if (HELP_ITEM_ENABLED) {
            String base64 = SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.help_item.Base64", null);

            if (base64 != null) {
                HELP_ITEM = ItemStackBuilder.of(SkullUtils.HELP_SKULL)
                        .name(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.help_item.name")).lore(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getStringList("enchant_menu.help_item.lore")).buildItem().build();
            } else {
                HELP_ITEM = ItemStackBuilder.of(CompMaterial.fromString(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.help_item.material")).toMaterial())
                        .name(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.help_item.name")).lore(SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getStringList("enchant_menu.help_item.lore")).buildItem().build();
            }

            HELP_ITEM_SLOT = SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getInt("enchant_menu.help_item.slot");

        }

        if (PICKAXE_ITEM_ENABLED) {
            PICKAXE_ITEM_SLOT = SupremePrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getInt("enchant_menu.pickaxe_slot");
        }
    }
    ...
    private Item getGuiItem(SupremePrisonEnchantment enchantment, EnchantGUI gui, int currentLevel) {
        ...
        if (enchantment.getBase64() != null && !enchantment.getBase64().isEmpty()) {
            builder = ItemStackBuilder.of(SkullUtils.DIAMOND_P_SKULL);
        }
