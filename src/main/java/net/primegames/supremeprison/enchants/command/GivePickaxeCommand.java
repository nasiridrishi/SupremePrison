...
public class GivePickaxeCommand {
    ...
    public GivePickaxeCommand(SupremePrisonEnchants plugin) {
        this.plugin = plugin;
    }
    ...
    public void register() {
        Commands.create()
                ...
                .handler(c -> {
                    ...
                    Map<SupremePrisonEnchantment, Integer> enchants = parseEnchantsFromInput(input);
    ...
    private Map<SupremePrisonEnchantment, Integer> parseEnchantsFromInput(String input) {
        Map<SupremePrisonEnchantment, Integer> enchants = new HashMap<>();
        ...
        for (String s : split) {
            ...
            try {
                SupremePrisonEnchantment enchantment = getEnchantsRepository().getEnchantByName(enchantData[0]);
                if (enchantment == null) {
