...
import net.primegames.supremeprison.enchants.api.events.NukeTriggerEvent;
...
public final class NukeEnchant extends SupremePrisonEnchantment {
    ...
    public NukeEnchant(SupremePrisonEnchants instance) {
        super(instance, 21);
