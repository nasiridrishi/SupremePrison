...
public final class TokenatorEnchant extends SupremePrisonEnchantment {

    private double chance;
    private String amountToGiveExpression;


    public TokenatorEnchant(SupremePrisonEnchants instance) {
        super(instance, 14);
    ...
    public void onBlockBreak(BlockBreakEvent e, int enchantLevel) {
        ...
        plugin.getCore().getTokens().getTokensManager().giveTokens(e.getPlayer(), randAmount, null, ReceiveCause.MINING, e.getBlock().getLocation());
    }
