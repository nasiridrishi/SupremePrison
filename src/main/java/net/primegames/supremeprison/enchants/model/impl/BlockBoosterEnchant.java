...
public final class BlockBoosterEnchant extends SupremePrisonEnchantment {

    private static final Map<UUID, Long> BOOSTED_PLAYERS = new HashMap<>();
    private double chance;

    public BlockBoosterEnchant(SupremePrisonEnchants instance) {
        super(instance, 17);
        this.chance = plugin.getEnchantsConfig().getYamlConfig().getDouble("enchants." + id + ".Chance");

        Events.subscribe(SupremePrisonBlockBreakEvent.class)
                .handler(e -> {
