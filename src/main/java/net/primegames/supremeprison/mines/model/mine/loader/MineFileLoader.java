...
public class MineFileLoader implements MineLoader<File> {
    ...
    public Mine load(File file) {
        try (FileReader reader = new FileReader(file)) {
            ...
            ResetType resetType = ResetType.INSTANT;
            ...
            return new Mine(this.manager, name, MineSelection.toWeCuboidRegion(region), teleportLocation, palette, resetType, resetPercentage, broadcastReset, blocksLeftHologram, blocksMinedHologram, timedResetHologram, mineEffects, resetTime);
        } catch (Exception e) {
