...
import net.primegames.supremeprison.gangs.commands.impl.admin.GangAdminSubCommand;
import net.primegames.supremeprison.gangs.commands.impl.value.GangValueSubCommand;
import net.primegames.supremeprison.gangs.gui.panel.GangPanelGUI;
...
import net.primegames.supremeprison.gangs.commands.impl.*;
...
public class GangCommand {
    ...
    public GangCommand(SupremePrisonGangs plugin) {
        this.plugin = plugin;
