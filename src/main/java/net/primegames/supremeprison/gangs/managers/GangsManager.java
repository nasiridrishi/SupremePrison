package net.primegames.supremeprison.gangs.managers;
...
import net.primegames.supremeprison.gangs.enums.GangNameCheckResult;
import net.primegames.supremeprison.gangs.enums.GangRenameResult;
import net.primegames.supremeprison.gangs.gui.admin.DisbandGangAdminGUI;
...
public class GangsManager {
    ...
    public GangsManager(SupremePrisonGangs plugin) {
        this.plugin = plugin;
