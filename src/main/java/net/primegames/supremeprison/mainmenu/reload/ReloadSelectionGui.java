package net.primegames.supremeprison.mainmenu.reload;

import net.primegames.supremeprison.SupremePrison;
import net.primegames.supremeprison.mainmenu.confirmation.ReloadModuleConfirmationGui;
...
public class ReloadSelectionGui extends Gui {
    ...
    public ReloadSelectionGui(SupremePrison core, Player player) {
