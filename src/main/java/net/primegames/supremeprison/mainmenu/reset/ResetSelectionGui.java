package net.primegames.supremeprison.mainmenu.reset;

import net.primegames.supremeprison.SupremePrison;
import net.primegames.supremeprison.mainmenu.confirmation.ResetModulePlayerDataConfirmationGui;
...
public class ResetSelectionGui extends Gui {
    ...
    public ResetSelectionGui(SupremePrison core, Player player) {
