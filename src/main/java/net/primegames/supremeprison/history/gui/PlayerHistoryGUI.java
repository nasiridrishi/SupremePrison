package net.primegames.supremeprison.history.gui;

import net.primegames.supremeprison.history.SupremePrisonHistory;
import net.primegames.supremeprison.history.gui.confirmation.PlayerClearHistoryConfirmationGUI;
...
public class PlayerHistoryGUI extends Gui {
    ...
    public PlayerHistoryGUI(Player viewer, OfflinePlayer target, SupremePrisonHistory plugin) {
