...
public class PlayerHistoryFilterGUI extends Gui {
    ...
    public PlayerHistoryFilterGUI(Player player, OfflinePlayer target, SupremePrisonHistory plugin) {
    ...
    public void redraw() {
        if (isFirstDraw()) {
            ...
            for (SupremePrisonModule module : this.plugin.getCore().getModules()) {
