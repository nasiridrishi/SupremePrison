...
public class XPrisonMVdWPlaceholder {
    ...
    private void registerRanksPlaceholders() {
        ...
        PlaceholderAPI.registerPlaceholder(plugin, "xprison_rankup_progress", event -> String.valueOf(plugin.getRanks().getRanksManager().getRankupProgress(event.getPlayer())));
