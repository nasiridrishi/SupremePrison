...
public final class EnchantGUI extends Gui {
    ...
    public static void init() {
        ...
        EMPTY_SLOT_ITEM = ItemStackBuilder.
                of(CompMaterial.fromString(XPrisonEnchants.getInstance().getEnchantsConfig().getYamlConfig().getString("enchant_menu.empty_slots")).toItem()).name("&e").buildItem().build();
